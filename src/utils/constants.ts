...
export const noTempalteRoutes_startsWith = ['/company-code', '/agreementpage', '/auth/login', '/auth/signup', '/auth/verification', '/auth/reset-password', '/auth/mfa', '/model/list-faces', '/model/video-analysis', '/printable/fvlconizationResult/']
