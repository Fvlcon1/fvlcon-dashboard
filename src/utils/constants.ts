...
export const noTempalteRoutes = ['*', '/', '/company-code', '/agreementpage', '/auth/login', '/auth/signup', '/auth/verification', '/auth/reset-password', '/auth/mfa', '/model/list-faces', '/model/video-analysis', '/printable/fvlconizationResult/cm6qkok620002wwntfs00x2cf']
