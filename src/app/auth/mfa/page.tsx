...
// import { AccountContext } from '../accounts/page'
...
//   useEffect(() => {
//     getSession().then(({ mfaEnabled } : {mfaEnabled : any}) => {
...
//   const getQRCode = () => {
//     getSession().then(({ accessToken, headers } : { accessToken : any, headers : any }) => {
...
//     getSession().then(({ user, accessToken, headers } : { user : any, accessToken : any, headers : any }) => {
//       if (typeof accessToken !== 'string') {
//         accessToken = accessToken.jwtToken
//       }
...
//   const disableMFA = (event : any) => {
//     event.preventDefault()

//     getSession().then(({ headers, accessToken } : { headers : any, accessToken : any }) => {
//       if (typeof accessToken !== 'string') {
//         accessToken = accessToken.jwtToken
//       }
