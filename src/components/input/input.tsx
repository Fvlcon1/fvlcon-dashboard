...
type InputProps = {
  ...
  const Input = ({
    ...
    return (
      <div
        className={`flex w-full flex-1 gap-2 px-[15px] py-2 h-[35px] items-center rounded-full bg-bg-secondary border-bg-tetiary border-[1px] border-solid duration-200 ${className}`}
        onClick={onClick}
        style={{
